module.exports = {
    ...
    compliments: () => {
        ...
        let compliments = `Your smile is contagious.
...
You're really something special.`
        ...
        let complimentsArr = compliments.split(`\n`);
...
A small donation is called for, Its the right thing to do.
...
The busiest person has the largest amount of time.
Dont be discouraged, because every wrong attempt discarded is another step forward.
Dont confuse recklessness with confidence.
...
Stand tall. Dont look down upon yourself.
...
Your work interests can capture the highest status or prestige.`
        ...
        let fortunesArr = fortunes.split(`\n`);
